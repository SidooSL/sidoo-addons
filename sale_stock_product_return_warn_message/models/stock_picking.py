...
class StockPicking(models.Model):
    ...
    def _compute_warning_message(self):
        warning_param = self.env['ir.config_parameter'].sudo().get_param('returnable.message')
        for picking in self:
    ...
    def _compute_is_returnable(self):
        for picking in self:
            picking.is_returnable = any(line.is_returnable for line in picking.move_line_ids)
